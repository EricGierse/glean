...
export const ICONS = {
  ...
  flame: wrap('<path d="M12 2.5c2.5 3 1 5.5-.5 7-1 1-2 2.2-2 3.8a2.5 2.5 0 0 0 5 0c0-.6-.2-1.1-.4-1.6 1.7.7 2.9 2.4 2.9 4.4a5 5 0 0 1-10 0c0-2.6 1.4-4.2 2.7-5.6C11 12.5 12.5 10.5 12 7c1 .7 2 1.7 2.3 3 .8-1.6.6-5-2.3-7.5z"/>', "currentColor"),
  sun: wrap('<circle cx="12" cy="12" r="4.2"/><path d="M12 2.5v2M12 19.5v2M4.6 4.6l1.4 1.4M18 18l1.4 1.4M2.5 12h2M19.5 12h2M4.6 19.4 6 18M18 6l1.4-1.4"/>'),
  moon: wrap('<path d="M20 14.5A8 8 0 0 1 9.5 4 7 7 0 1 0 20 14.5z"/>'),
