...
export const PRICING = {
  monthly: { id: "monthly", label: "Monthly", price: 3, per: "month", note: "3 days free, then billed monthly" },
  yearly: { id: "yearly", label: "Yearly", price: 30, per: "year", note: "2 months free vs monthly", badge: "2 months free" },
};
