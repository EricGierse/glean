...
//
// Billing model:
//   • Pro Monthly — $4 / mo    • Pro Yearly — $35 / yr  (~27% off)
...
//
// Free tier = manual capture + basic CSV. Pro unlocks auto-capture, inbox sync,
// AI receipt scan, unlimited/QuickBooks export, custom categories, tax & multi-currency.
//
...
export const PRICING = {
  ...
  yearly: { id: "yearly", label: "Yearly", price: 35, per: "year", note: "3 days free · save 27%", badge: "Best value" },
};
