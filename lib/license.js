...
//
// Billing model:
//   • Pro Monthly — $3 / mo    • Pro Yearly — $30 / yr  (~17% off · 2 months free)
...
export const PRICING = {
  monthly: { id: "monthly", label: "Monthly", price: 3, per: "month", note: "3 days free, then billed monthly", priceId: "price_1TiuOxRoDItE65rHWiKbaBDk" },
  yearly:  { id: "yearly",  label: "Yearly",  price: 30, per: "year",  note: "2 months free vs monthly", badge: "2 months free", priceId: "price_1TiuOxRoDItE65rHIp48wy0C" },
};

// TODO: replace with real Stripe Payment Link URLs once created
export const CHECKOUT_URL = {
  monthly: "https://glean.app/upgrade", // replace with buy.stripe.com/... monthly link
  yearly:  "https://glean.app/upgrade", // replace with buy.stripe.com/... yearly link
};
